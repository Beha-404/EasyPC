...
{
    /// <inheritdoc />
    public partial class InitalV11 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "Gigabyte GP-UD850GM PG5 GEU2", "800W", 300, "PSU" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Pcs",
                columns: new[] { "Id", "Available", "CaseId", "GraphicsCardId", "MotherBoardId", "Name", "Price", "ProcessorId", "PsuId", "RamId", "Type" },
                values: new object[,]
                {
                    { 1, true, 1, 1, 1, "Gaming PC", 1200, 1, 1, 1, "PC" },
                    { 2, true, 2, 2, 2, "Streaming PC", 1500, 2, 2, 2, "PC" }
                });
